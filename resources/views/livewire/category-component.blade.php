                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{$products->count()}}</strong> items for you From <strong>{{$category_name}}</strong>!
                                </p>
                            </div>
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{$orderBy=='Default Sorting' ? 'active': ''}}" wire:click.prevent="changeOrderBy('Default Sorting')">Default Sorting</a></li>
                                            ...
                                            <li><a class="{{$orderBy=='Release Date' ? 'active': ''}}" wire:click.prevent="changeOrderBy('Release Date')">Release Date</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                @foreach($categories as $category)
                                    <li><a href="{{route('product_category',$category->slug)}}">{{$category->name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!-- Fillter By Price -->
